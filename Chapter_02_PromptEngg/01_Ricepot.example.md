...
Instructions:                              
  ...
  - [Don't] - Don't use the css selectors, ID, name and other things.                                
...
- I have external URLs, external staging URLs. I 
  will give you the external username and password as well                                             
Output:                                      
    Provide only:                                     
